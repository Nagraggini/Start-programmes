    ...
    public static void stone_paper_sissor_game() {
        ...
        try {
            ...
            if (number != 0 && number != 1 && number != 2) {
                /*
                 * Ez a feltetel akkor lesz igaz, ha a number erteke sem 0, sem 1, sem 2.
                 * Vagyis, ha a number barmilyen mas erteku, mint 0, 1, vagy 2, akkor a feltetel
                 * teljesül, es kiirja a lenti hibaüzenetet:
                 */

                System.out.println(
                        "Legy szíves, adj meg egy ervenyes szamot                                     (0, 1, 2).");
